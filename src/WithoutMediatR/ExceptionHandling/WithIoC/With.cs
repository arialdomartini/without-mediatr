...
namespace WithoutMediatR.ExceptionHandling.WithIoC;
...
public class With
{
    ...
    async Task exceptions_are_handled()
    {
        ...
        Assert.Equal("---- Exception Handler: 'WithoutMediatR.ExceptionHandling.WithIoC.AccessDeniedExceptionHandler'\r\n", _stringWriter.ToString());
